...
export const translations: Record<Language, TranslationDict> = {
  ...
  ms: {
    search: 'Carian',
    banks: 'Semua Bank',
    routing: 'Nombor Routing',
    swift: 'Kod SWIFT',
    blog: 'Blog & Panduan',
    ifsc: 'Kod IFSC',
    bik: 'Kod BIK',
    blz: 'Kod BLZ',
    blzCode: 'BLZ & IBAN Jerman',
    sortCode: 'Sort Code (UK)',
    bsb: 'Kod BSB (Australia)',
    bsbCode: 'Kod BSB Australia',
    country: 'Negara',
    ...
    india: 'India',
    russia: 'Rusia',
    usa: 'Amerika Syarikat (USA)',
    uk: 'United Kingdom (UK)',
    canada: 'Kanada',
    australia: 'Australia',
    uae: 'Emiriah Arab Bersatu (UAE)',
    singapore: 'Singapura',
    germany: 'Jerman',
    malaysia: 'Malaysia (Bahasa Melayu)',
    allBanks: 'Semua Bank',
    allDivisions: 'Semua Negeri & Wilayah Persekutuan',
    divisionState: 'Negeri / Wilayah',
    districtCity: 'Bandar / Daerah',
    allDistricts: 'Semua Bandar / Daerah',
    searchPlaceholder: 'Cari Bank, Cawangan, Kod Bank, Routing 5-digit IBG, DuitNow, SWIFT...',
    searchBtn: 'Cari',
    totalBanks: 'Jumlah Bank',
    totalBranches: 'Jumlah Cawangan',
    verifiedCodes: 'Kod Disahkan BNM',
    routingDecoder: 'Penyahkod Routing IBG',
    bikDecoder: 'Penyahkod BIK Rusia',
    blzDecoder: 'Penyahkod BLZ Jerman',
    sortCodeDecoder: 'Penyahkod Sort Code UK',
    bsbDecoder: 'Penyahkod BSB Australia',
    ...
    popularBanks: 'Bank Popular',
    tagline: 'Pangkalan data rasmi kod bank Malaysia, nombor routing 5-digit IBG, DuitNow, SWIFT/BIC serta sistem perbankan global.',
    footerDesc: 'Pangkalan data rasmi kod bank Malaysia, nombor routing 5-digit IBG, DuitNow, SWIFT/BIC dan direktori cawangan bank berlesen Bank Negara Malaysia (BNM) 2026.',
    routingNumberTitle: 'Direktori Routing & IBG',
    swiftCodeTitle: 'Pencari Kod SWIFT / BIC',
    ifscCodeTitle: 'Pencari Kod IFSC',
    micrCodeTitle: 'Pencari Kod MICR',
    bikCodeTitle: 'Pencari Kod BIK',
    howToUseRouting: 'Panduan: Cara Menggunakan Kod Bank, IBG & DuitNow',
    bankBranchDirectory: 'Direktori Bank & Cawangan'
  }
};
