...
## 2. Universal Multi-Country Standard Architecture
Every new country added to this platform MUST strictly implement the complete multi-country standard:
...
- **National Banking Clearing Code Support**:
  - Dedicated code validators, formatters, and search engine support (e.g., UK Sort Codes, US ABA RTN, Russian BIK/Corr Accounts, Indian IFSC/MICR, Bangladesh BEFTN Routing).
- **Modular Country Sitemaps & Google Search Console Compliance**:
  ...
  - Update `generate-sitemap.js` whenever a new country or dataset is integrated.
